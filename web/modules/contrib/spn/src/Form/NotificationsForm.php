...
class NotificationsForm extends FormBase {
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    \Drupal::messenger()->addMessage($this->t('Your settings have been saved succesfully.'));
  }
  ...
  public function getEmailSubject($token) {
    $email = unserialize(\Drupal::config('spn.settings')->get($token));
